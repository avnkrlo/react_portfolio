        ...
        <>
            <footer className="mt-10 bg-white dark:bg-gray-900">
                ...
                <hr className="my-6 border-gray-200 sm:mx-auto dark:border-gray-700 lg:my-8"/>
                    <div className="sm:flex sm:items-center sm:justify-between">
                        <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">Built by
                            <Link to="/react_portfolio/" className="hover:underline"> Aivan Karlo Geronimo</Link> using TypeScript + React + Vite and using Github Pages.
                        </span>
                    </div>
                </div>
            </footer>        
