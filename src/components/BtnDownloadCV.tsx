...
export default function btnDownloadCV() {
    return (
        <Link to={Cv} target='_blank' download
            className="inline-flex items-center px-3 py-2 whitespace-nowrap text-md text-left text-white bg-blue-700 border border-blue-500 rounded-lg transition-all duration-300 ease-out hover:bg-white/20 hover:backdrop-blur-lg hover:border-white/50 hover:shadow-lg hover:scale-105
                ...
                <span className="ml-1.5 text-black dark:text-white">Download CV</span>
        </Link>
    );
};