...
export default function LinksPage() {
    return (
        <>
            <div>
                <ul className="grid place-content-center mt-20 w-auto">
                    <li className="mb-4">
                    ...
                    <li className="mb-4">
                        <Link to="https://leetcode.com/u/avnkrlo/" target="_blank" rel="noopener noreferrer" 
                            className="flex items-center justify-center gap-4 p-5 bg-white rounded-lg shadow-sm hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
                                <svg className="w-6 h-6" fill="#FFFFFF" viewBox="0 0 24 24" role="img" xmlns="http://www.w3.org/2000/svg" stroke="#FFFFFF">
                                ...
                                <p className="w-full text-center font-md text-white">LeetCode</p>
                        </Link>
                    </li>
