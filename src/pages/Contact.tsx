                    ...
                    <li className="mb-4">
                        <Link to="https://www.linkedin.com/in/aivangeronimo/" target="_blank" rel="noopener noreferrer" 
                            className="inline-flex items-center px-5 py-5 text-md text-left text-white bg-blue-700 border border-blue-500 rounded-lg transition-all duration-300 ease-out hover:bg-white/20 hover:backdrop-blur-lg hover:border-white/50 hover:shadow-lg hover:scale-105
                                ...
                                <span className="ml-2 text-black dark:text-white">LinkedIn</span>
                        </Link>
                    </li>
                    ...
                    <li className="mb-4">
                        <Link to="https://github.com/avnkrlo" target="_blank" rel="noopener noreferrer" 
                            className="inline-flex items-center px-5 py-5 text-md text-left text-white bg-blue-700 border border-blue-500 rounded-lg transition-all duration-300 ease-out hover:bg-white/20 hover:backdrop-blur-lg hover:border-white/50 hover:shadow-lg hover:scale-105
                                ...
                                <span className="ml-2 text-black dark:text-white">Github</span>
                        </Link>
                    </li>
                    ...
                    <li className="mb-4">
                        <Link to="https://wa.link/4bd27x" target="_blank" rel="noopener noreferrer" 
                            className="inline-flex items-center px-5 py-5 text-md text-left text-white bg-blue-700 border border-blue-500 rounded-lg transition-all duration-300 ease-out hover:bg-white/20 hover:backdrop-blur-lg hover:border-white/50 hover:shadow-lg hover:scale-105
                                ...
                                <span className="ml-2 text-black dark:text-white">WhatsApp</span>
                        </Link>
                    </li>
                </ul>
            </div>
