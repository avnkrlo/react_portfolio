...
export default function Contact() {
    ...
    useEffect(() => {
        if (location.state?.scrollTo === "cal") {
                        ...
                        <li>
                            <Link to="https://www.linkedin.com/in/aivangeronimo/" target="_blank" rel="noopener noreferrer" 
                                className="flex items-center justify-center gap-1.5
                                            ...
                                            px-5
                                            text-md
                                            bg-blue-700 border border-blue-500 rounded-lg
                                            transition-all duration-300 ease-out
                                            hover:bg-white/20 hover:backdrop-blur-lg hover:border-white/50
                                            hover:shadow-lg hover:scale-105
                                            focus:ring-4 focus:ring-blue-700">
                                    <svg className="w-6 h-6 shrink-0 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
                                        <path fillRule="evenodd" d="M12.51 8.796v1.697a3.738 3.738 0 0 1 3.288-1.684c3.455 0 4.202 2.16 4.202 4.97V19.5h-3.2v-5.072c0-1.21-.244-2.766-2.128-2.766-1.827 0-2.139 1.317-2.139 2.676V19.5h-3.19V8.796h3.168ZM7.2 6.106a1.61 1.61 0 0 1-.988 1.483 1.595 1.595 0 0 1-1.743-.348A1.607 1.607 0 0 1 5.6 4.5a1.601 1.601 0 0 1 1.6 1.606Z" clipRule="evenodd"/>
                                        <path d="M7.2 8.809H4V19.5h3.2V8.809Z"/>
                                    </svg>
                                    <span className="whitespace-nowrap text-black dark:text-white">LinkedIn</span>
                            </Link>
                        </li>
                        ...
                        <li>
                            <Link to="https://github.com/avnkrlo" target="_blank" rel="noopener noreferrer" 
                                className="flex items-center justify-center gap-1.5
                                    ...
                                    <span className="whitespace-nowrap text-black dark:text-white">Github</span>
                            </Link>
                        </li>
                        ...
                        <li>
                            <Link to="https://wa.link/4bd27x" target="_blank" rel="noopener noreferrer" 
                                className="flex items-center justify-center gap-1.5
                                    ...
                                    <span className="whitespace-nowrap text-black dark:text-white">WhatsApp</span>
                            </Link>
                        </li>
                    </ul>
                </section>
